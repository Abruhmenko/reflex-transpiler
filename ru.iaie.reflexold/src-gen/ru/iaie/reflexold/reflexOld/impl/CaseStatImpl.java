 ...
 * </p>
 * <ul>
 *   <li>{@link ru.iaie.reflexold.reflexOld.impl.CaseStatImpl#getOption <em>Option</em>}</li>
 * </ul>
 *
 * @generated
 */
public class CaseStatImpl extends SwitchOptionStatSequenceImpl implements CaseStat
{
  ...
  {
    return ReflexOldPackage.Literals.CASE_STAT;
  }
  ...
  public NotificationChain basicSetOption(Expression newOption, NotificationChain msgs)
  {
    ...
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ReflexOldPackage.CASE_STAT__OPTION, oldOption, newOption);
  ...
  public void setOption(Expression newOption)
  {
    if (newOption != option)
    {
      ...
      if (option != null)
        msgs = ((InternalEObject)option).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ReflexOldPackage.CASE_STAT__OPTION, null, msgs);
      if (newOption != null)
        msgs = ((InternalEObject)newOption).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ReflexOldPackage.CASE_STAT__OPTION, null, msgs);
      msgs = basicSetOption(newOption, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ReflexOldPackage.CASE_STAT__OPTION, newOption, newOption));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case ReflexOldPackage.CASE_STAT__OPTION:
