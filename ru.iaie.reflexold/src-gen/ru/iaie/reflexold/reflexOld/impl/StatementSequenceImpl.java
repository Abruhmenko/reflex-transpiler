 ...
 * </p>
 * <ul>
 *   <li>{@link ru.iaie.reflexold.reflexOld.impl.StatementSequenceImpl#getStatements <em>Statements</em>}</li>
 * </ul>
 *
 * @generated
 */
public class StatementSequenceImpl extends MinimalEObjectImpl.Container implements StatementSequence
{
  ...
  {
    return ReflexOldPackage.Literals.STATEMENT_SEQUENCE;
  }
  ...
  public EList<Statement> getStatements()
  {
    if (statements == null)
    {
      statements = new EObjectContainmentEList<Statement>(Statement.class, this, ReflexOldPackage.STATEMENT_SEQUENCE__STATEMENTS);
    }
    return statements;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case ReflexOldPackage.STATEMENT_SEQUENCE__STATEMENTS:
