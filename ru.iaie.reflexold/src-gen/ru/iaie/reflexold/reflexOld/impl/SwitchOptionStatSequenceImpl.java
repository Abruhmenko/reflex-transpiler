 ...
 * </p>
 * <ul>
 *   <li>{@link ru.iaie.reflexold.reflexOld.impl.SwitchOptionStatSequenceImpl#getStatements <em>Statements</em>}</li>
 *   <li>{@link ru.iaie.reflexold.reflexOld.impl.SwitchOptionStatSequenceImpl#isHasBreak <em>Has Break</em>}</li>
 * </ul>
 *
 * @generated
 */
public class SwitchOptionStatSequenceImpl extends MinimalEObjectImpl.Container implements SwitchOptionStatSequence
{
  ...
  {
    return ReflexOldPackage.Literals.SWITCH_OPTION_STAT_SEQUENCE;
  }
  ...
  public EList<Statement> getStatements()
  {
    if (statements == null)
    {
      statements = new EObjectContainmentEList<Statement>(Statement.class, this, ReflexOldPackage.SWITCH_OPTION_STAT_SEQUENCE__STATEMENTS);
    }
    return statements;
  }
  ...
  public void setHasBreak(boolean newHasBreak)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ReflexOldPackage.SWITCH_OPTION_STAT_SEQUENCE__HAS_BREAK, oldHasBreak, hasBreak));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case ReflexOldPackage.SWITCH_OPTION_STAT_SEQUENCE__STATEMENTS:
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      ...
      case ReflexOldPackage.SWITCH_OPTION_STAT_SEQUENCE__HAS_BREAK:
        return isHasBreak();
    }
