 ...
 * </p>
 * <ul>
 *   <li>{@link ru.iaie.reflexold.reflexOld.impl.PostfixOpImpl#getRef <em>Ref</em>}</li>
 *   <li>{@link ru.iaie.reflexold.reflexOld.impl.PostfixOpImpl#getOp <em>Op</em>}</li>
 * </ul>
 *
 * @generated
 */
public class PostfixOpImpl extends UnaryExpressionImpl implements PostfixOp
{
  ...
  {
    return ReflexOldPackage.Literals.POSTFIX_OP;
  }
    ...
    if (ref != null && ref.eIsProxy())
    {
      ...
      if (ref != oldRef)
      {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, ReflexOldPackage.POSTFIX_OP__REF, oldRef, ref));
      }
    }
    return ref;
  }
  ...
  public void setRef(IdReference newRef)
  {
    ...
    ref = newRef;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ReflexOldPackage.POSTFIX_OP__REF, oldRef, ref));
  }
  ...
  public void setOp(InfixPostfixOp newOp)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ReflexOldPackage.POSTFIX_OP__OP, oldOp, op));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case ReflexOldPackage.POSTFIX_OP__REF:
        if (resolve) return getRef();
        return basicGetRef();
      case ReflexOldPackage.POSTFIX_OP__OP:
        return getOp();
    }
