 ...
 * </p>
 * <ul>
 *   <li>{@link ru.iaie.reflexold.reflexOld.impl.StartProcStatImpl#getProcess <em>Process</em>}</li>
 * </ul>
 *
 * @generated
 */
public class StartProcStatImpl extends StatementImpl implements StartProcStat
{
  ...
  {
    return ReflexOldPackage.Literals.START_PROC_STAT;
  }
    ...
    if (process != null && process.eIsProxy())
    {
      ...
      if (process != oldProcess)
      {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, ReflexOldPackage.START_PROC_STAT__PROCESS, oldProcess, process));
      }
    }
    return process;
  }
  ...
  public void setProcess(ru.iaie.reflexold.reflexOld.Process newProcess)
  {
    ...
    process = newProcess;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ReflexOldPackage.START_PROC_STAT__PROCESS, oldProcess, process));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case ReflexOldPackage.START_PROC_STAT__PROCESS:
