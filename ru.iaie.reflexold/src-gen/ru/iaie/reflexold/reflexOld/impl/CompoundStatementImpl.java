 ...
 * </p>
 * <ul>
 *   <li>{@link ru.iaie.reflexold.reflexOld.impl.CompoundStatementImpl#getStatements <em>Statements</em>}</li>
 * </ul>
 *
 * @generated
 */
public class CompoundStatementImpl extends StatementImpl implements CompoundStatement
{
  ...
  {
    return ReflexOldPackage.Literals.COMPOUND_STATEMENT;
  }
  ...
  public EList<Statement> getStatements()
  {
    if (statements == null)
    {
      statements = new EObjectContainmentEList<Statement>(Statement.class, this, ReflexOldPackage.COMPOUND_STATEMENT__STATEMENTS);
    }
    return statements;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case ReflexOldPackage.COMPOUND_STATEMENT__STATEMENTS:
