 ...
 * </p>
 * <ul>
 *   <li>{@link ru.iaie.reflexold.reflexOld.impl.EnumImpl#getEnumMembers <em>Enum Members</em>}</li>
 * </ul>
 *
 * @generated
 */
public class EnumImpl extends MinimalEObjectImpl.Container implements ru.iaie.reflexold.reflexOld.Enum
{
  /**
  ...
  {
    return ReflexOldPackage.Literals.ENUM;
  }
  ...
  public EList<EnumMember> getEnumMembers()
  {
    if (enumMembers == null)
    {
      enumMembers = new EObjectContainmentEList<EnumMember>(EnumMember.class, this, ReflexOldPackage.ENUM__ENUM_MEMBERS);
    }
    return enumMembers;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case ReflexOldPackage.ENUM__ENUM_MEMBERS:
