 ...
 * </p>
 * <ul>
 *   <li>{@link ru.iaie.reflexold.reflexOld.impl.SetStateStatImpl#isNext <em>Next</em>}</li>
 *   <li>{@link ru.iaie.reflexold.reflexOld.impl.SetStateStatImpl#getState <em>State</em>}</li>
 * </ul>
 *
 * @generated
 */
public class SetStateStatImpl extends StatementImpl implements SetStateStat
{
  ...
  {
    return ReflexOldPackage.Literals.SET_STATE_STAT;
  }
  ...
  public void setNext(boolean newNext)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ReflexOldPackage.SET_STATE_STAT__NEXT, oldNext, next));
  }
  ...
  public State getState()
  {
    if (state != null && state.eIsProxy())
    {
      ...
      {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, ReflexOldPackage.SET_STATE_STAT__STATE, oldState, state));
      }
    }
    return state;
  }
  ...
  public void setState(State newState)
  {
    ...
    state = newState;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ReflexOldPackage.SET_STATE_STAT__STATE, oldState, state));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case ReflexOldPackage.SET_STATE_STAT__NEXT:
        return isNext();
      case ReflexOldPackage.SET_STATE_STAT__STATE:
