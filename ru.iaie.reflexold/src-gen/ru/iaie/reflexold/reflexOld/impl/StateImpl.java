 ...
 * </p>
 * <ul>
 *   <li>{@link ru.iaie.reflexold.reflexOld.impl.StateImpl#getName <em>Name</em>}</li>
 *   <li>{@link ru.iaie.reflexold.reflexOld.impl.StateImpl#getStateFunction <em>State Function</em>}</li>
 *   <li>{@link ru.iaie.reflexold.reflexOld.impl.StateImpl#getTimeoutFunction <em>Timeout Function</em>}</li>
 * </ul>
 *
 * @generated
 */
public class StateImpl extends MinimalEObjectImpl.Container implements State
{
  ...
  {
    return ReflexOldPackage.Literals.STATE;
  }
  ...
  public void setName(String newName)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ReflexOldPackage.STATE__NAME, oldName, name));
  }
  ...
  public NotificationChain basicSetStateFunction(StatementSequence newStateFunction, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ReflexOldPackage.STATE__STATE_FUNCTION, oldStateFunction, newStateFunction);
  ...
  public void setStateFunction(StatementSequence newStateFunction)
  {
    if (newStateFunction != stateFunction)
    {
      ...
      if (stateFunction != null)
        msgs = ((InternalEObject)stateFunction).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ReflexOldPackage.STATE__STATE_FUNCTION, null, msgs);
      if (newStateFunction != null)
        msgs = ((InternalEObject)newStateFunction).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ReflexOldPackage.STATE__STATE_FUNCTION, null, msgs);
      msgs = basicSetStateFunction(newStateFunction, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ReflexOldPackage.STATE__STATE_FUNCTION, newStateFunction, newStateFunction));
  }
  ...
  public NotificationChain basicSetTimeoutFunction(TimeoutFunction newTimeoutFunction, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ReflexOldPackage.STATE__TIMEOUT_FUNCTION, oldTimeoutFunction, newTimeoutFunction);
      if (msgs == null) msgs = notification; else msgs.add(notification);
    }
    return msgs;
  }
  ...
  public void setTimeoutFunction(TimeoutFunction newTimeoutFunction)
  {
    if (newTimeoutFunction != timeoutFunction)
    {
      ...
      if (timeoutFunction != null)
        msgs = ((InternalEObject)timeoutFunction).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ReflexOldPackage.STATE__TIMEOUT_FUNCTION, null, msgs);
      if (newTimeoutFunction != null)
        msgs = ((InternalEObject)newTimeoutFunction).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ReflexOldPackage.STATE__TIMEOUT_FUNCTION, null, msgs);
      msgs = basicSetTimeoutFunction(newTimeoutFunction, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ReflexOldPackage.STATE__TIMEOUT_FUNCTION, newTimeoutFunction, newTimeoutFunction));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case ReflexOldPackage.STATE__STATE_FUNCTION:
        return basicSetStateFunction(null, msgs);
      case ReflexOldPackage.STATE__TIMEOUT_FUNCTION:
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case ReflexOldPackage.STATE__NAME:
        return getName();
      case ReflexOldPackage.STATE__STATE_FUNCTION:
