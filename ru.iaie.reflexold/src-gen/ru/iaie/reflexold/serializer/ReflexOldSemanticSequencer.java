...
public class ReflexOldSemanticSequencer extends AbstractDelegatingSemanticSequencer {
	...
	public void sequence(ISerializationContext context, EObject semanticObject) {
		...
		if (epackage == ReflexOldPackage.eINSTANCE)
			...
			case ReflexOldPackage.ENUM:
				sequence_Enum(context, (ru.iaie.reflexold.reflexOld.Enum) semanticObject); 
				return; 
			...
			case ReflexOldPackage.PHYSICAL_VARIABLE:
				if (rule == grammarAccess.getPhysicalVariableRule()
			...
			case ReflexOldPackage.PROCESS:
				sequence_Process(context, (ru.iaie.reflexold.reflexOld.Process) semanticObject); 
				return; 
	...
	protected void sequence_AdditiveExpression(ISerializationContext context, AdditiveExpression semanticObject) {
		if (errorAcceptor != null) {
			if (transientValues.isValueTransient(semanticObject, ReflexOldPackage.Literals.LOGICAL_OR_EXPRESSION__LEFT) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, ReflexOldPackage.Literals.LOGICAL_OR_EXPRESSION__LEFT));
			if (transientValues.isValueTransient(semanticObject, ReflexOldPackage.Literals.ADDITIVE_EXPRESSION__ADD_OP) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, ReflexOldPackage.Literals.ADDITIVE_EXPRESSION__ADD_OP));
	...
	protected void sequence_CastExpression(ISerializationContext context, CastExpression semanticObject) {
		if (errorAcceptor != null) {
			if (transientValues.isValueTransient(semanticObject, ReflexOldPackage.Literals.CAST_EXPRESSION__TYPE) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, ReflexOldPackage.Literals.CAST_EXPRESSION__TYPE));
			if (transientValues.isValueTransient(semanticObject, ReflexOldPackage.Literals.LOGICAL_OR_EXPRESSION__RIGHT) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, ReflexOldPackage.Literals.LOGICAL_OR_EXPRESSION__RIGHT));
		}
		SequenceFeeder feeder = createSequencerFeeder(context, semanticObject);
	...
	protected void sequence_ClockDefinition(ISerializationContext context, ClockDefinition semanticObject) {
		if (errorAcceptor != null) {
			if (transientValues.isValueTransient(semanticObject, ReflexOldPackage.Literals.CLOCK_DEFINITION__VALUE) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, ReflexOldPackage.Literals.CLOCK_DEFINITION__VALUE));
		}
		SequenceFeeder feeder = createSequencerFeeder(context, semanticObject);
		feeder.accept(grammarAccess.getClockDefinitionAccess().getValueINTEGERTerminalRuleCall_1_0(), semanticObject.getValue());
		feeder.finish();
	}
	...
	protected void sequence_CompareExpression(ISerializationContext context, CompareExpression semanticObject) {
		if (errorAcceptor != null) {
			if (transientValues.isValueTransient(semanticObject, ReflexOldPackage.Literals.LOGICAL_OR_EXPRESSION__LEFT) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, ReflexOldPackage.Literals.LOGICAL_OR_EXPRESSION__LEFT));
			if (transientValues.isValueTransient(semanticObject, ReflexOldPackage.Literals.COMPARE_EXPRESSION__CMP_OP) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, ReflexOldPackage.Literals.COMPARE_EXPRESSION__CMP_OP));
			if (transientValues.isValueTransient(semanticObject, ReflexOldPackage.Literals.LOGICAL_OR_EXPRESSION__RIGHT) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, ReflexOldPackage.Literals.LOGICAL_OR_EXPRESSION__RIGHT));
		}
		SequenceFeeder feeder = createSequencerFeeder(context, semanticObject);
	...
	protected void sequence_Const(ISerializationContext context, Const semanticObject) {
		if (errorAcceptor != null) {
			if (transientValues.isValueTransient(semanticObject, ReflexOldPackage.Literals.CONST__NAME) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, ReflexOldPackage.Literals.CONST__NAME));
			if (transientValues.isValueTransient(semanticObject, ReflexOldPackage.Literals.CONST__VALUE) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, ReflexOldPackage.Literals.CONST__VALUE));
		}
		SequenceFeeder feeder = createSequencerFeeder(context, semanticObject);
		feeder.accept(grammarAccess.getConstAccess().getNameIDTerminalRuleCall_1_0(), semanticObject.getName());
		feeder.accept(grammarAccess.getConstAccess().getValueExpressionParserRuleCall_2_0(), semanticObject.getValue());
		feeder.finish();
	}
	 ...
	 */
	protected void sequence_Enum(ISerializationContext context, ru.iaie.reflexold.reflexOld.Enum semanticObject) {
		genericSequencer.createSequence(context, semanticObject);
	}
	...
	protected void sequence_EqualityExpression(ISerializationContext context, EqualityExpression semanticObject) {
		if (errorAcceptor != null) {
			if (transientValues.isValueTransient(semanticObject, ReflexOldPackage.Literals.LOGICAL_OR_EXPRESSION__LEFT) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, ReflexOldPackage.Literals.LOGICAL_OR_EXPRESSION__LEFT));
			if (transientValues.isValueTransient(semanticObject, ReflexOldPackage.Literals.EQUALITY_EXPRESSION__EQ_CMP_OP) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, ReflexOldPackage.Literals.EQUALITY_EXPRESSION__EQ_CMP_OP));
			if (transientValues.isValueTransient(semanticObject, ReflexOldPackage.Literals.LOGICAL_OR_EXPRESSION__RIGHT) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, ReflexOldPackage.Literals.LOGICAL_OR_EXPRESSION__RIGHT));
		}
		SequenceFeeder feeder = createSequencerFeeder(context, semanticObject);
	 ...
	 *
	 * Constraint:
	 *     (process=[Process|ID] variables+=[ProcessVariable|ID] variables+=[ProcessVariable|ID]*)
	 */
	...
	protected void sequence_InfixOp(ISerializationContext context, InfixOp semanticObject) {
		if (errorAcceptor != null) {
			if (transientValues.isValueTransient(semanticObject, ReflexOldPackage.Literals.INFIX_OP__OP) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, ReflexOldPackage.Literals.INFIX_OP__OP));
			if (transientValues.isValueTransient(semanticObject, ReflexOldPackage.Literals.INFIX_OP__REF) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, ReflexOldPackage.Literals.INFIX_OP__REF));
		}
		SequenceFeeder feeder = createSequencerFeeder(context, semanticObject);
		feeder.accept(grammarAccess.getInfixOpAccess().getOpInfixPostfixOpEnumRuleCall_0_0(), semanticObject.getOp());
		feeder.accept(grammarAccess.getInfixOpAccess().getRefIdReferenceIDTerminalRuleCall_1_0_1(), semanticObject.eGet(ReflexOldPackage.Literals.INFIX_OP__REF, false));
		feeder.finish();
	}
	...
	protected void sequence_MultiplicativeExpression(ISerializationContext context, MultiplicativeExpression semanticObject) {
		if (errorAcceptor != null) {
			if (transientValues.isValueTransient(semanticObject, ReflexOldPackage.Literals.LOGICAL_OR_EXPRESSION__LEFT) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, ReflexOldPackage.Literals.LOGICAL_OR_EXPRESSION__LEFT));
			if (transientValues.isValueTransient(semanticObject, ReflexOldPackage.Literals.MULTIPLICATIVE_EXPRESSION__MUL_OP) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, ReflexOldPackage.Literals.MULTIPLICATIVE_EXPRESSION__MUL_OP));
			if (transientValues.isValueTransient(semanticObject, ReflexOldPackage.Literals.LOGICAL_OR_EXPRESSION__RIGHT) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, ReflexOldPackage.Literals.LOGICAL_OR_EXPRESSION__RIGHT));
		}
		SequenceFeeder feeder = createSequencerFeeder(context, semanticObject);
	...
	protected void sequence_PhysicalVariable(ISerializationContext context, PhysicalVariable semanticObject) {
		if (errorAcceptor != null) {
			if (transientValues.isValueTransient(semanticObject, ReflexOldPackage.Literals.PHYSICAL_VARIABLE__TYPE) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, ReflexOldPackage.Literals.PHYSICAL_VARIABLE__TYPE));
			if (transientValues.isValueTransient(semanticObject, ReflexOldPackage.Literals.PHYSICAL_VARIABLE__NAME) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, ReflexOldPackage.Literals.PHYSICAL_VARIABLE__NAME));
			if (transientValues.isValueTransient(semanticObject, ReflexOldPackage.Literals.PHYSICAL_VARIABLE__MAPPING) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, ReflexOldPackage.Literals.PHYSICAL_VARIABLE__MAPPING));
		}
		SequenceFeeder feeder = createSequencerFeeder(context, semanticObject);
	 ...
	 *         name=ID 
	 *         mapping=PortMapping 
	 *         (local?='LOCAL' | local?='ÀŒ ¿À' | ((shared?='FOR' | shared?='ƒÀﬂ') (processes+=[Process|ID] processes+=[Process|ID]*)?))
	 *     )
	 */
	 ...
	 *
	 * Constraint:
	 *     (port=[Port|ID] bits=INTEGER)
	 */
	protected void sequence_PortMapping(ISerializationContext context, PortMapping semanticObject) {
		if (errorAcceptor != null) {
			if (transientValues.isValueTransient(semanticObject, ReflexOldPackage.Literals.PORT_MAPPING__PORT) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, ReflexOldPackage.Literals.PORT_MAPPING__PORT));
			if (transientValues.isValueTransient(semanticObject, ReflexOldPackage.Literals.PORT_MAPPING__BITS) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, ReflexOldPackage.Literals.PORT_MAPPING__BITS));
		}
		SequenceFeeder feeder = createSequencerFeeder(context, semanticObject);
		feeder.accept(grammarAccess.getPortMappingAccess().getPortPortIDTerminalRuleCall_1_0_1(), semanticObject.eGet(ReflexOldPackage.Literals.PORT_MAPPING__PORT, false));
		feeder.accept(grammarAccess.getPortMappingAccess().getBitsINTEGERTerminalRuleCall_3_0(), semanticObject.getBits());
		feeder.finish();
	}
	...
	protected void sequence_Port(ISerializationContext context, Port semanticObject) {
		if (errorAcceptor != null) {
			if (transientValues.isValueTransient(semanticObject, ReflexOldPackage.Literals.PORT__TYPE) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, ReflexOldPackage.Literals.PORT__TYPE));
			if (transientValues.isValueTransient(semanticObject, ReflexOldPackage.Literals.PORT__NAME) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, ReflexOldPackage.Literals.PORT__NAME));
			if (transientValues.isValueTransient(semanticObject, ReflexOldPackage.Literals.PORT__ADDR1) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, ReflexOldPackage.Literals.PORT__ADDR1));
			if (transientValues.isValueTransient(semanticObject, ReflexOldPackage.Literals.PORT__ADDR2) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, ReflexOldPackage.Literals.PORT__ADDR2));
			if (transientValues.isValueTransient(semanticObject, ReflexOldPackage.Literals.PORT__SIZE) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, ReflexOldPackage.Literals.PORT__SIZE));
		}
		SequenceFeeder feeder = createSequencerFeeder(context, semanticObject);
	...
	protected void sequence_PostfixOp(ISerializationContext context, PostfixOp semanticObject) {
		if (errorAcceptor != null) {
			if (transientValues.isValueTransient(semanticObject, ReflexOldPackage.Literals.POSTFIX_OP__REF) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, ReflexOldPackage.Literals.POSTFIX_OP__REF));
			if (transientValues.isValueTransient(semanticObject, ReflexOldPackage.Literals.POSTFIX_OP__OP) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, ReflexOldPackage.Literals.POSTFIX_OP__OP));
		}
		SequenceFeeder feeder = createSequencerFeeder(context, semanticObject);
		feeder.accept(grammarAccess.getPostfixOpAccess().getRefIdReferenceIDTerminalRuleCall_0_0_1(), semanticObject.eGet(ReflexOldPackage.Literals.POSTFIX_OP__REF, false));
	 ...
	 *
	 * Constraint:
	 *     (type=Type name=ID (local?='LOCAL' | local?='ÀŒ ¿À' | ((shared?='FOR' | shared?='ƒÀﬂ') (processes+=[Process|ID] processes+=[Process|ID]*)?)))
	 */
	 ...
	 *
	 * Constraint:
	 *     (name=ID (imports+=ImportedVariableList | variables+=ProcessVariable)* states+=State*)
	 */
	protected void sequence_Process(ISerializationContext context, ru.iaie.reflexold.reflexOld.Process semanticObject) {
		genericSequencer.createSequence(context, semanticObject);
	}
	...
	protected void sequence_ProgramVariable(ISerializationContext context, ProgramVariable semanticObject) {
		if (errorAcceptor != null) {
			if (transientValues.isValueTransient(semanticObject, ReflexOldPackage.Literals.PROGRAM_VARIABLE__TYPE) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, ReflexOldPackage.Literals.PROGRAM_VARIABLE__TYPE));
			if (transientValues.isValueTransient(semanticObject, ReflexOldPackage.Literals.PROGRAM_VARIABLE__NAME) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, ReflexOldPackage.Literals.PROGRAM_VARIABLE__NAME));
		}
		SequenceFeeder feeder = createSequencerFeeder(context, semanticObject);
	 ...
	 *
	 * Constraint:
	 *     (en?='PROGR'? name=ID clock=ClockDefinition (consts+=Const | enums+=Enum | functions+=Function | ports+=Port | processes+=Process)*)
	 */
	 ...
	 *
	 * Constraint:
	 *     (next?='NEXT' | next?='—À≈ƒ”ﬁŸ≈≈' | state=[State|ID])
	 */
	...
	protected void sequence_ShiftExpression(ISerializationContext context, ShiftExpression semanticObject) {
		if (errorAcceptor != null) {
			if (transientValues.isValueTransient(semanticObject, ReflexOldPackage.Literals.LOGICAL_OR_EXPRESSION__LEFT) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, ReflexOldPackage.Literals.LOGICAL_OR_EXPRESSION__LEFT));
			if (transientValues.isValueTransient(semanticObject, ReflexOldPackage.Literals.SHIFT_EXPRESSION__SHIFT_OP) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, ReflexOldPackage.Literals.SHIFT_EXPRESSION__SHIFT_OP));
			if (transientValues.isValueTransient(semanticObject, ReflexOldPackage.Literals.LOGICAL_OR_EXPRESSION__RIGHT) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, ReflexOldPackage.Literals.LOGICAL_OR_EXPRESSION__RIGHT));
		}
		SequenceFeeder feeder = createSequencerFeeder(context, semanticObject);
	...
	protected void sequence_StartProcStat(ISerializationContext context, StartProcStat semanticObject) {
		if (errorAcceptor != null) {
			if (transientValues.isValueTransient(semanticObject, ReflexOldPackage.Literals.START_PROC_STAT__PROCESS) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, ReflexOldPackage.Literals.START_PROC_STAT__PROCESS));
		}
		SequenceFeeder feeder = createSequencerFeeder(context, semanticObject);
		feeder.accept(grammarAccess.getStartProcStatAccess().getProcessProcessIDTerminalRuleCall_2_0_1(), semanticObject.eGet(ReflexOldPackage.Literals.START_PROC_STAT__PROCESS, false));
		feeder.finish();
	}
	 ...
	 *
	 * Constraint:
	 *     ((time=INTEGER | ref=[IdReference|ID]) body=Statement)
	 */
